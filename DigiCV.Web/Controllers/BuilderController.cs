...
public class BuilderController : Controller
{
    ...
    public BuilderController(ILifetimeScope scope, ILogger<BuilderController> logger,
        ...
        IPdfGenerationService pdfGenerationService, IViewRenderer viewRenderer, IConverter pdfConverter, BuilderCreateModel builderCreateModel)
    {
    ...
    public async Task<IActionResult> GetResume(Guid Id)
    {
        ...
        if (model.ResumeProperty != null)
        {
            ...
            if (UserIdFromResume != null && UserIdFromResume == currentUserID)
            {
                ...
                ViewBag.IdForPDF = Id;
                ViewBag.ResumeTitle = model.ResumeProperty.Title;
        ...
        ViewBag.IdForPDF = Id;
        ViewBag.Username = user.UserName;
        ViewBag.ResumeTitle = model.ResumeProperty.Title.Replace(' ', '-');
        ...
        if (PDFTemplateName != null) {
            ...
            if (model.ResumeProperty != null)
            {
                ...
                if (UserIdFromResume != null && UserIdFromResume == currentUserID)
                {
                    ...
                    var pdfBytes = _pdfGenerationService.GeneratePdf(createModel);
